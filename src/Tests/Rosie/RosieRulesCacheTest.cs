...
//             var updateResult = await RosieRulesCache.Instance.HandleCacheUpdate();
//
...
//
//            await _cache.HandleCacheUpdate();
//
...
//         }
        ...
        private void InitConfigAndCache(string rawConfig, string testName)
        {
